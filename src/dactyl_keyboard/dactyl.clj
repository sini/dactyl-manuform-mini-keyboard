...
(def case-walls
  (union
   ...
   (wall-brace (partial key-place 0 0) -0.01 0.2 web-post-tl (partial left-key-place -0.8 -0.8) -0.2 -0.33 web-post)
   (wall-brace (partial left-key-place 0 0.1) 0 0.1 web-post (partial left-key-place 0 0.1) -0.1 0 web-post)
   ; front wall
   (key-wall-brace 3 lastrow   0 0 web-post-bl 3 lastrow 0.5 0 web-post-br)
   (key-wall-brace 3 lastrow 0.5 0 web-post-br 4 cornerrow 0.5 -1 web-post-bl)
   (for [x (range 4 ncols)] (key-wall-brace x cornerrow 0 -1.15 web-post-bl x       cornerrow 0 -0.5 web-post-br)) ; TODO fix extra wall
   (for [x (range 5 ncols)] (key-wall-brace x cornerrow 0 -1 web-post-bl (dec x) cornerrow 0 -1 web-post-br))
   ; thumb walls
   (wall-brace thumb-mr-place  0 -0.7 web-post-br thumb-tr-place  0 -0.5 thumb-post-br)
   (wall-brace thumb-mr-place  0 -0.7 web-post-br thumb-mr-place  0 -0.5 web-post-bl)
   (wall-brace thumb-br-place  0 -0.5 web-post-br thumb-br-place  0 -0.5 web-post-bl)
   (wall-brace thumb-bl-place  0  0.5 web-post-tr thumb-bl-place  0  0.5 web-post-tl)
   (wall-brace thumb-br-place -0.5  0 web-post-tl thumb-br-place -0.5  0 web-post-bl)
   ...
   ; thumb tweeners
   (wall-brace thumb-mr-place  0 -0.5 web-post-bl thumb-br-place  0 -0.5 web-post-br)
   (wall-brace thumb-bl-place -0.5  0 web-post-bl thumb-br-place -0.5  0 web-post-tl)
   (wall-brace thumb-tr-place  0 -0.5 thumb-post-br (partial key-place 3 lastrow)  0 -0.5 web-post-bl)
   ; clunky bit on the top left thumb connection  (normal connectors don't work well)
   (bottom-hull
    (left-key-place cornerrow -1 (translate (wall-locate2 0 0) web-post))
    (left-key-place cornerrow -1 (translate (wall-locate3 -0.5 0) web-post))
    (thumb-bl-place (translate (wall-locate2 -0.5 0) web-post-tr))
    (thumb-bl-place (translate (wall-locate3 -0.3 0) web-post-tr)))
   (hull
    (left-key-place cornerrow -1.22 (translate (wall-locate2 -0.8 0.4) web-post))
    (left-key-place cornerrow -1.34 (translate (wall-locate3 -0.52 0.3) web-post))
    (thumb-bl-place (translate (wall-locate2 -0.5 0) web-post-tr))
    (thumb-bl-place (translate (wall-locate3 -0.3 0) web-post-tr))
    (thumb-tl-place web-post-tl))
   (hull
    (left-key-place cornerrow -1 web-post)
    (left-key-place cornerrow -1 (translate (wall-locate1 -0.5 0) web-post))
    (left-key-place cornerrow -1 (translate (wall-locate2 -0.5 0) web-post))
    (left-key-place cornerrow -1 (translate (wall-locate3 -0.5 0) web-post))
    (thumb-tl-place web-post-tl))
   (hull
    (left-key-place cornerrow -1 web-post)
    (left-key-place cornerrow -1 (translate (wall-locate1 -0.7 0) web-post))
    (key-place 0 cornerrow web-post-bl)
    (thumb-tl-place web-post-tl))
   (hull
    (thumb-bl-place web-post-tr)
